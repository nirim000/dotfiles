...
if [ -f /var/usrlocal/share/ml4w-hyprland/dotfiles/.config/ml4w/version/name ]; then
    installed_version=$(cat /var/usrlocal/share/ml4w-hyprland/dotfiles/.config/ml4w/version/name)
